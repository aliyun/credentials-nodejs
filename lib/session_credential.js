...
class SessionCredential extends DefaultCredential {
  ...
  needUpdateCredential() {
    ...
    // console.log(this.sessionCredential);
    // console.log(utils.timestamp(new Date(), this.durationSeconds * 0.95 * 1000));
    const expireTime = utils.timestamp(new Date(), this.durationSeconds * 0.95 * 1000);
